...
<script type="text/javascript">
	function fn_process(p_command) {
		...
		$.ajax({
			...
			type : "post",
			async : false,
			url : "http://localhost:8060/pro16/customer",
			data : param,
...
<body>
	<form name="frm" id="frm">
		...
		<table border="1">
			<tr align="center">
				<th bgcolor="lightpink">
				<img src ="before.jpg" width="20px" height="20px" name="before" onClick="fn_process('before')">고객 번호<img src="after.jpg"  width="20px" height="20px" name="after" onClick="fn_process('after')"></th>
