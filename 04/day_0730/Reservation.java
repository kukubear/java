...
public class Reservation {
	...
	private String type;// 좌석 타입 -> 한글자
	private int num; // 좌석번호
	private String typeNum;
	private HashMap reserveInfo = new HashMap(); // s,a,b좌석 각각 10개씩 있음
		
	Reservation(String name, String type, int num, String typeNum, HashMap reserveInfo)
	{	
		this.name=name;
		this.type=type;
		this.num=num;
	...
	// 예약자정보 저장
	public void saveReserveInfo(String name, String type, int num) {
		typeNum = type+Integer.toString(num);
		reserveInfo.put(name, typeNum);
	...
	public HashMap getReserveInfo() {
		return reserveInfo;
	}

	public void setReserveInfo(HashMap reserveInfo) {
		this.reserveInfo = reserveInfo;
	}
